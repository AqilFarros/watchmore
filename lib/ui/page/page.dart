...
part 'loading/loading_review.dart';
part 'review_page.dart';
part 'loading/loading_video.dart';
part 'video_page.dart';
part 'welcome_page.dart';
part 'login_page.dart';
part 'layout/general_page.dart';
part 'favorite_page.dart';
part 'watchlist_page.dart';
part 'loading/loading_favorite_page.dart';
part 'loading/loading_watchlist_page.dart';
